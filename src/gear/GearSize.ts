...
export class GearSize extends GearBase {
  ...
  protected init(): void {
    this.$default = new GearSizeValue(
      this.$owner.width,
      this.$owner.height,
      this.$owner.scaleX,
      this.$owner.scaleY
  ...
  protected addStatus(pageId: string, value: string): void {
    ...
    if (pageId == null) gv = this.$default
    else {
      ...
      if (a || b) {
        ...
        let vars: any = {
          onChange: () => {
            ...
            if (a)
              this.$owner.setSize(
                this.$tweenValue.width,
                this.$tweenValue.height,
                this.$owner.gearXY.controller == this.$controller
              )
            if (b) this.$owner.setScale(this.$tweenValue.scaleX, this.$tweenValue.scaleY)
            this.$owner.$gearLocked = false
          }
        }
        if (this.$tweenValue == null) this.$tweenValue = new GearSizeValue()
