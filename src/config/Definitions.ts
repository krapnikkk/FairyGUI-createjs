...
export class InteractiveEvents {
  public static Down: string = createjs.Touch.isSupported() ? 'mousedown' : 'mousedown'
  public static Cancel: string = createjs.Touch.isSupported() ? 'mousecancel' : 'mousecancel'
  public static Up: string = createjs.Touch.isSupported() ? 'stagemouseup' : 'stagemouseup'
  public static Click: string = createjs.Touch.isSupported() ? 'click' : 'click'
  public static UpOutside: string = createjs.Touch.isSupported()
    ? 'mouseupoutside'
    : 'mouseupoutside'
  public static Move: string = createjs.Touch.isSupported() ? 'stagemousemove' : 'stagemousemove'
  public static Over: string | null = createjs.Touch.isSupported() ? 'mouseover' : 'mouseover'
  public static Out: string | null = createjs.Touch.isSupported() ? 'mouseout' : 'mouseout'
  //mouse only
...
export const enum PopupDirection {
  Auto,
  Down,
  Up
}
export const enum ScrollBarDisplayType {
  Default,
  Visible,
  Auto,
  Hidden
}
export const enum OverflowType {
  Visible,
  Hidden,
  Scroll,
  Scale,
...
export const enum AutoSizeType {
  None,
  Both,
  Height,
  Shrink
...
export const enum LoaderFillType {
  None,
  Scale,
  ScaleMatchHeight,
  ScaleMatchWidth,
...
export const enum ListLayoutType {
  SingleColumn,
  SingleRow,
  FlowHorizontal,
  FlowVertical,
...
export const enum PackageItemType {
  Image,
  Swf,
  MovieClip,
  Sound,
...
export const enum ProgressTitleType {
  Percent,
  ValueAndMax,
  Value,
  Max
...
export const enum MovieClipStatus {
  NORMAL,
  LOOPING,
  STOPPING,
  ENDED
...
export interface Texture extends createjs.SpriteSheetFrame {
